...
class Ibelarus extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('categories')->insert([
            ...
            'icon' => 'fa fa-cutlery',
            'url' => 'http://ibelarus.dev/minsk/restaurants/',
        ...
        DB::table('categories')->insert([
            ...
            'icon' => 'fa fa-coffee',
            'url' => 'http://ibelarus.dev/minsk/cafe/',
        ...
        DB::table('companies')->insert([
            ...
            'latitude' => '53.947102',
            'longitude' => '27.689104',
            'url' => 'http://company2.ibelarus.dev/',
            'main_photo_url' => '',
            'address' => 'Street',
            'tel' => '+375291234567',
            'last_review' => '',
        ...
        DB::table('companies')->insert([
            ...
            'latitude' => '53.897912',
            'longitude' => '27.543317',
            'url' => 'http://chumatski-shlyah.ibelarus.dev',
            'main_photo_url' => '',
        ...
        DB::table('companies')->insert([
            ...
            'latitude' => '53.901737',
            'longitude' => '27.553953',
            'url' => 'http://pan-hmelju.ibelarus.dev',
